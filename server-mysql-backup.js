...
const db = mysql.createConnection({
  ...
  password: process.env.DB_PASSWORD || 'upsc2027',
  database: process.env.DB_NAME || 'farm_dashboard'
});
...
const storeDb = mysql.createConnection({
  ...
  user: process.env.DB_USER || 'root',
  password: process.env.DB_PASSWORD || 'upsc2027',
  database: process.env.STORE_DB_NAME || 'farm_market'
});
...
const govDb = mysql.createConnection({
  ...
  user: process.env.DB_USER || 'root',
  password: process.env.DB_PASSWORD || 'upsc2027',
  database: process.env.GOV_DB_NAME || 'gov'
});
